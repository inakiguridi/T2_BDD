...
WHERE EXISTS (
  ...
  AND r.review_date >= '2022-08-01' AND r.review_date < '2022-09-01';
...
JOIN order_items oi ON oi.order_id = o.order_id
JOIN books b        ON b.book_id   = oi.book_id
WHERE o.order_date >= '2021-07-01' AND o.order_date < '2021-08-01'
GROUP BY b.book_id, b.title
ORDER BY revenue DESC LIMIT 10;
...
JOIN order_items oi ON oi.order_id = o.order_id
JOIN books b        ON b.book_id   = oi.book_id
WHERE o.order_date >= '2024-04-01' AND o.order_date < '2024-05-01'
GROUP BY b.book_id, b.title
ORDER BY revenue DESC LIMIT 10;
...
WHERE EXISTS (
  ...
  AND r.review_date >= '2024-02-01' AND r.review_date < '2024-03-01';
...
JOIN order_items oi ON oi.order_id = o.order_id
JOIN books b        ON b.book_id   = oi.book_id
WHERE o.order_date >= '2022-12-01' AND o.order_date < '2023-01-01'
GROUP BY b.book_id, b.title
ORDER BY revenue DESC LIMIT 10;
